...
import type { Program, ExecutiveSummary, ParcelData } from "@/lib/types";
...
function ReportWizardPage() {
  ...
  }, [isInstantMode, instantLoading, programs, zones, zoneNames, censusData, cityZoning, parcelData, wizardState]);
  ...
  useEffect(() => {
    ...
    return () => clearTimeout(timer);
  }, [isShareMode, shareAutoGenerated, programs, zones, zoneNames, censusData, cityZoning, parcelData, wizardState]);
  ...
  }, [wizardState, programs, zones, zoneNames, censusData, cityZoning, parcelData]);
