...
function ReportWizardPage() {
  ...
  useEffect(() => {
    ...
    if ((wizardState.reportType === "location-incentives" || wizardState.reportType === "developer-analysis") && !zones && wizardState.lat) return;
    ...
    return () => clearTimeout(timer);
  }, [isShareMode, shareAutoGenerated, programs, zones, zoneNames, censusData, cityZoning, wizardState]);
