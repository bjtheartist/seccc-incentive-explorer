...
- When getPageContext returns localSupportOrganizations, their ids and public descriptions have been re-attested against the server's curated registry. Treat them as place-based or specialist support already surfaced by the report. Use their supportLanes, supportTypes, and serviceGeography to explain why one may be useful.
