...
export function generateReport(
  ...
  doc.text("Generated by Chicago Incentive Explorer", MARGIN, H - 18);
  doc.setFontSize(7);
  ...
  for (const prog of detailedPrograms) {
    ...
    doc.setFontSize(7);
    setColor(doc, LIGHT_GRAY);
    doc.text(`${prog.name}  |  Chicago Incentive Explorer`, MARGIN, H - 10);
  }
  ...
  setColor(doc, LIGHT_GRAY);
  doc.text(
    `Report generated ${dateStr} by Chicago Incentive Explorer. Data is informational and not a guarantee of eligibility.`,
    MARGIN,
    H - 10
  );
