...
/**
 * Logistics access — straight-line distances from a point to the nearest
 * expressway, nearest freight rail main line, and both Chicago airports.
 * Network data comes from /data/transport-network.geojson, built by
 * scripts/sync-transport.mjs.
 */
...
/** Format miles for display: "0.4 mi" under 10, "12 mi" above. */
