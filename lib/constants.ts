...
export const ZONE_DESCRIPTIONS: Record<string, string> = {
  ...
  nrhpDistricts: "Federally recognized historic districts. A property here may be eligible for the 20% federal Historic Tax Credit on certified rehabilitation costs, subject to Secretary of the Interior's Standards review and the building being income-producing.",
