...
## Where it lives
- Postgres table `grants_active` (plus `grants_active_loads` for load history). Verified on the disposable Neon branch `grants-db-load-2026-09-11`; not loaded to production until approved.
